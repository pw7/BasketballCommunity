...
class SendPostPage extends StatefulWidget {
  ...
  final Post post;
  final String text;
  const SendPostPage({Key key, this.type, this.post, this.text})
      : super(key: key);
  @override
...
class _SendPostPageState extends State<SendPostPage> {
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    maxLines: 5,
                    decoration:
                        InputDecoration.collapsed(hintText: "分享当下的想法吧..."),
                  ),
                ),
                _buildSingleImg(),
                //图片
  ...
  _buildForwardPost() {
    var url = widget.post.forwardId == null
        ? widget.post.imageUrl
        : widget.post.forwardImageUrl;
    if (url == null) {
      url = '';
    }
