...
import 'package:flutter_application/utils/image_picker.dart';
import 'package:flutter_application/utils/toast.dart';
import 'package:flutter_application/widget/MySeparator.dart';
            ...
            RepaintBoundary(
              ...
              child: Container(
                ...
                padding: EdgeInsets.symmetric(
                    horizontal: ScreenUtil().setWidth(50), vertical: 55.h),
                        ...
                        Column(
                          ...
                          children: <Widget>[
                            Text(
                              user.username ?? '',
                              style:
                                  TextStyle(fontSize: ScreenUtil().setSp(52)),
                            ),
                            SizedBox(
                              height: ScreenUtil().setHeight(20),
                            ),
                            Text(
                              '${user.followNum}关注 ${user.fanNum}粉丝',
                              style: TextStyle(
              ...
              child: Row(
                ...
                children: <Widget>[
                  _buildGridItem(MyIcons.save, '保存到相册', () async {
                    var res =
                        await ImageSaver.save(await _capturePng(rootWidgetKey));
                    if (res.contains('.jpg')) {
                      Toast.popToast('保存成功');
                    } else {
                  ...
                  _buildGridItem(MyIcons.scan, '扫一扫', () {})
                ],
              ),
            ),
            Expanded(
